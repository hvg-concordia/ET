...
rw []
\\ sg `M1_F ∩ M2_S ∩ M3_F ∩ L2_S ∪ M1_F ∩ M2_S ∩ M3_F ∩ L2_F ∪ M1_F ∩ M2_F =
       BIG_UNION p [M1_F ∩ M2_S ∩ M3_F ∩ L2_S;M1_F ∩ M2_S ∩ M3_F ∩ L2_F;M1_F ∩ M2_F] `
   >-( rw [BIG_UNION_DEF]
       \\ rw [EXTENSION]
       \\ metis_tac [])
\\ POP_ORW
\\ DEP_REWRITE_TAC [PROB_BIG_UNION]
\\ rw []
   >-(metis_tac [EVENTS_INTER])
   >-(metis_tac [EVENTS_INTER])
   >-(metis_tac [EVENTS_INTER])   
...
rw []
\\ sg `M1_F ∩ M2_F ∪ M1_S ∩ M2_F ∩ M3_F ∩ L1_F ∪ M1_S ∩ M2_F ∩ M3_F ∩ L1_S  =
       BIG_UNION p [M1_F ∩ M2_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_S] `
   >-( rw [BIG_UNION_DEF]
       \\ rw [EXTENSION]
       \\ metis_tac [])
\\ POP_ORW
...
\\ sg `M1_S ∩ M2_S ∩ L1_F ∩ L2_F ∪ M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_F ∪
       M1_S ∩ M2_F ∩ M3_F ∩ L1_F ∪ M1_F ∩ M2_S ∩ M3_S ∩ L1_F ∩ L2_F ∪
       M1_F ∩ M2_S ∩ M3_F ∩ L2_F ∪ M1_F ∩ M2_F  =
       BIG_UNION p [M1_S ∩ M2_S ∩ L1_F ∩ L2_F; M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_F;
           	    M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_F ∩ M2_S ∩ M3_S ∩ L1_F ∩ L2_F;
           	    M1_F ∩ M2_S ∩ M3_F ∩ L2_F; M1_F ∩ M2_F] `
   >-( rw [BIG_UNION_DEF]
       \\ rw [EXTENSION]

...
(*---------------------------------------------------------------------------*)
(*          Description: Formalization of Event Trees in Higher-order Logic  *)
(*                                                                           *)
(*          HOL4-Kananaskis 13 		 			     	     *)
(*									     *)
...
ET_EVENT[L2_S;L2_F][[M1_S; M1_F];[M2_S; M2_F];[M3_S; M3_F];[L1_S; L1_F]]
        [[31;30;29;28;27;26;25;24];[23;22];[21;20];[17;16];[15;14];[13;12];[9;8];[7;6];[5;4];[3;2;1;0]]
	[[M1_F; M2_F];[M1_F; M2_S; M3_F; L2_F];[M1_F; M2_S; M3_F; L2_S];[M1_F; M2_S; M3_S; L1_S];
         [M1_S; M2_F; M3_F; L1_F];[M1_S; M2_F; M3_F; L1_S];[M1_S; M2_F; M3_S; L1_S];
	 [M1_S; M2_S; L1_F; L2_F];[M1_S; M2_S; L1_F; L2_S];[M1_S; M2_S; L1_S]] [11;12;13]`;
(*--------------------------------------------------------------------------------------------------*)
...
ET_EVENT[L2_S;L2_F][[M1_S; M1_F];[M2_S; M2_F];[M3_S; M3_F];[L1_S; L1_F]]
	...
	[[M1_F; M2_F];[M1_F; M2_S; M3_F; L2_F];[M1_F; M2_S; M3_F; L2_S];[M1_F; M2_S; M3_S; L1_S];
         [M1_S; M2_F; M3_F; L1_F];[M1_S; M2_F; M3_F; L1_S];[M1_S; M2_F; M3_S; L1_S];
	 [M1_S; M2_S; L1_F; L2_F];[M1_S; M2_S; L1_F; L2_S];[M1_S; M2_S; L1_S]] [6;7;13]`;
(*--------------------------------------------------------------------------------------------------*)
...
ET_EVENT[L2_S;L2_F][[M1_S; M1_F];[M2_S; M2_F];[M3_S; M3_F];[L1_S; L1_F]]
	...
	[[M1_F; M2_F];[M1_F; M2_S; M3_F; L2_F];[M1_F; M2_S; M3_F; L2_S];[M1_F; M2_S; M3_S; L1_S];
         [M1_S; M2_F; M3_F; L1_F];[M1_S; M2_F; M3_F; L1_S];[M1_S; M2_F; M3_S; L1_S];
	 [M1_S; M2_S; L1_F; L2_F];[M1_S; M2_S; L1_F; L2_S];[M1_S; M2_S; L1_S]] [2;5;7;10;12;13]`;
(*--------------------------------------------------------------------------------------------------*)
...
val PROB_PATH2 = store_thm("PROB_PATH2",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
...
\\ sg `M1_S ∩ M2_S ∩ L1_F ∩ L2_F =
   BIG_INTER p [M1_S; M2_S; L1_F; L2_F]`
   >-( rw [BIG_INTER_DEF]
       \\ rw [INTER_ASSOC]
...
\\ fs []
\\ DEP_REWRITE_TAC [PROB_BIG_INTER]
\\ fs []
...
val PROB_PATH5 = store_thm("PROB_PATH5",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
...
\\ sg `M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_F =
   BIG_INTER p [M1_S; M2_F; M3_S; L1_F; L2_F]`
   >-( rw [BIG_INTER_DEF]
       \\ rw [INTER_ASSOC]
...
val PROB_PATH6 = store_thm("PROB_PATH6",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
  (prob p (M1_S ∩ M2_F ∩ M3_F ∩ L1_F) =
...
\\ sg `M1_S ∩ M2_F ∩ M3_F ∩ L1_F =
   BIG_INTER p [M1_S; M2_F; M3_F; L1_F]`
   >-( rw [BIG_INTER_DEF]
       \\ rw [INTER_ASSOC]
...
val PROB_PATH7 = store_thm("PROB_PATH7",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
...
\\ sg `M1_S ∩ M2_F ∩ M3_F ∩ L1_S =
   BIG_INTER p [M1_S; M2_F; M3_F; L1_S]`
   >-( rw [BIG_INTER_DEF]
       \\ rw [INTER_ASSOC]
...
val PROB_PATH10 = store_thm("PROB_PATH10",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
...
\\ sg `M1_F ∩ M2_S ∩ M3_S ∩ L1_F ∩ L2_F =
   BIG_INTER p [M1_F; M2_S; M3_S; L1_F; L2_F]`
   >-( rw [BIG_INTER_DEF]
       \\ rw [INTER_ASSOC]
...
val PROB_PATH11 = store_thm("PROB_PATH11",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
...
>- ( rw[]
     ...
     \\ irule MUTUAL_INDEP_APPEND1 
     \\ rw[]
     \\ once_rewrite_tac[(prove(``!a b c. a::b::d::f::c = [a;b;d;f]++c``,rw[]))]
     \\ irule MUTUAL_INDEP_FRONT_APPEND 
     \\ Q.EXISTS_TAC `[M3_S]`
     \\ once_rewrite_tac[APPEND_ASSOC]
     \\ irule MUTUAL_INDEP_APPEND1 
     \\ rw[]
     \\ once_rewrite_tac[(prove(``!a b c. a::b::d::f::e::g::c = [a;b;d;f;e;g]++c``,rw[]))]
     \\ irule MUTUAL_INDEP_FRONT_APPEND 
     \\ Q.EXISTS_TAC `[L1_S]`
     \\ once_rewrite_tac[APPEND_ASSOC]
     \\ irule MUTUAL_INDEP_APPEND1  
     \\ rw[]
     \\ once_rewrite_tac[(prove(``!a b c f g h I. a::b::d::f::e::g::h::I =
                                                 [a;b;d;f;e;g;h]++I``,rw[]))]
    \\ irule MUTUAL_INDEP_FRONT_APPEND 
    \\ Q.EXISTS_TAC `[L1_F]`
    \\ once_rewrite_tac[APPEND_ASSOC]
...
\\ sg `M1_F ∩ M2_S ∩ M3_F ∩ L2_S =
   BIG_INTER p [M1_F; M2_S; M3_F; L2_S]`
   >-( rw [BIG_INTER_DEF]
       \\ rw [INTER_ASSOC]
...
val PROB_PATH12 = store_thm("PROB_PATH12",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
  (prob p (M1_F ∩ M2_S ∩ M3_F ∩ L2_F) =
...
>- ( rw[]    
    ...
    \\ irule MUTUAL_INDEP_APPEND1 
    \\ rw[]
    \\ once_rewrite_tac[(prove(``!a b c f g h I J. a::b::d::f::e::g::h::I::J =
                                                 [a;b;d;f;e;g;h;I]++J``,rw[]))]
    \\ irule MUTUAL_INDEP_FRONT_APPEND 
    \\ Q.EXISTS_TAC `[L2_S]`
    \\ once_rewrite_tac[APPEND_ASSOC]
    \\ irule MUTUAL_INDEP_APPEND1 
...
\\ sg `M1_F ∩ M2_S ∩ M3_F ∩ L2_F =
   BIG_INTER p [M1_F; M2_S; M3_F; L2_F]`
   >-( rw [BIG_INTER_DEF]
       \\ rw [INTER_ASSOC]
...
val PROB_PATH13 = store_thm("PROB_PATH13",
``prob_space p /\
  MUTUAL_INDEP  p [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\
  (!x'. MEM x' [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]
        ==> x'  IN  events p ) ==>
...
(*-------------------------------------------*)  
(* LEMMA 17 Disjont of Load A Failure Paths  *)
(*-------------------------------------------*)

val DISJOINT_LOAD_A_FAILURE_PATHS = store_thm("DISJOINT_LOAD_A_FAILURE_PATHS",
``ALL_DISTINCT [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\  
  disjoint {M1_S; M1_F; {}}   /\ disjoint {M2_S; M2_F; {}}   /\
  disjoint {M3_S; M3_F; {}} /\ disjoint {L1_S; L1_F; {}} /\ disjoint {L2_S; L2_F; {}} /\
  ALL_DISTINCT  [{M1_S; M1_F; {}}; {M2_S; M2_F; {}}; {M3_S; M3_F; {}};
                 {L1_S; L1_F; {}}; {L2_S; L2_F; {}}] ==>
  (disjoint {M1_F ∩ M2_S ∩ M3_F ∩ L2_S; M1_F ∩ M2_S ∩ M3_F ∩ L2_F; M1_F ∩ M2_F; {}})``,
...
(*-------------------------------------------*)  
(* LEMMA 18 Disjont of Load B Failure Paths  *)
(*-------------------------------------------*)

val DISJOINT_LOAD_B_FAILURE_PATHS = store_thm("DISJOINT_LOAD_B_FAILURE_PATHS",
``ALL_DISTINCT [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\  
  disjoint {M1_S; M1_F; {}}   /\ disjoint {M2_S; M2_F; {}}   /\
  disjoint {M3_S; M3_F; {}} /\ disjoint {L1_S; L1_F; {}} /\ disjoint {L2_S; L2_F; {}} /\
  ALL_DISTINCT  [{M1_S; M1_F; {}}; {M2_S; M2_F; {}}; {M3_S; M3_F; {}};
                 {L1_S; L1_F; {}}; {L2_S; L2_F; {}}] ==>
  (disjoint {M1_F ∩ M2_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_S;{}})``,
once_rewrite_tac [disjoint, ALL_DISTINCT]
\\ fs[EXTENSION] \\ metis_tac[]);
...
(*-------------------------------------------*)  
(* LEMMA 19 Disjont of Load C Failure Paths  *)
(*-------------------------------------------*)

val DISJOINT_LOAD_C_FAILURE_PATHS = store_thm("DISJOINT_LOAD_C_FAILURE_PATHS",
``ALL_DISTINCT [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\  
  disjoint {M1_S; M1_F; {}}   /\ disjoint {M2_S; M2_F; {}}   /\
  disjoint {M3_S; M3_F; {}} /\ disjoint {L1_S; L1_F; {}} /\ disjoint {L2_S; L2_F; {}} /\
  ALL_DISTINCT  [{M1_S; M1_F; {}}; {M2_S; M2_F; {}}; {M3_S; M3_F; {}};
                 {L1_S; L1_F; {}}; {L2_S; L2_F; {}}] ==>
  (disjoint {M1_S ∩ M2_S ∩ L1_F ∩ L2_F; M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_F;
             M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_F ∩ M2_S ∩ M3_S ∩ L1_F ∩ L2_F;
	     M1_F ∩ M2_S ∩ M3_F ∩ L2_F; M1_F ∩ M2_F; {}})``,
once_rewrite_tac [disjoint, ALL_DISTINCT]
\\ fs[EXTENSION] \\ metis_tac[]);
...
(*--------------------------------------------*)   
(* LEMMA 20  (Probability of Load A Failure)  *)
(*--------------------------------------------*)

val PROB_LOAD_A_FAILURE  = store_thm("PROB_LOAD_A_FAILURE",
``!M1_S M1_F M2_S M2_F M3_S M3_F L1_S L1_F L2_S L2_F p.

  (prob_space p)  /\
  
  ALL_DISTINCT [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F] /\  

  ALL_DISTINCT [ M1_S ∩ M2_S ∩ L1_S;
  	         M1_S ∩ M2_S ∩ L1_F ∩ L2_S;
		 M1_S ∩ M2_S ∩ L1_F ∩ L2_F;
		 M1_S ∩ M2_F ∩ M3_S ∩ L1_S;
		 M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_S;
 ...
 (prob p (LOAD_A_FAILURE [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]) =

 (prob p M1_F) * ((prob p M2_S) * ((prob p M3_F) * (prob p L2_S))) +
 (prob p M1_F) * ((prob p M2_S) * ((prob p M3_F) * (prob p L2_F))) +
 (prob p M1_F) * (prob p M2_F))``,

rw [ETREE_LOAD_A_FAILURE_PATHS]
\\ sg `disjoint  {M1_F ∩ M2_S ∩ M3_F ∩ L2_S; M1_F ∩ M2_S ∩ M3_F ∩ L2_F; M1_F ∩ M2_F; {}}`
   >-( DEP_REWRITE_TAC [DISJOINT_LOAD_A_FAILURE_PATHS]
       \\ fs [])
\\ sg `additive p `
   >-(rw [PROB_SPACE_ADDITIVE])
\\ sg ` prob p (M1_F ∩ M2_S ∩ M3_F ∩ L2_S ∪ M1_F ∩ M2_S ∩ M3_F ∩ L2_F ∪ M1_F ∩ M2_F) =
      prob p (ETREE (NODE
      (EVENT_TREE_LIST [M1_F ∩ M2_S ∩ M3_F ∩ L2_S; M1_F ∩ M2_S ∩ M3_F ∩ L2_F; M1_F ∩ M2_F; {}])))`
...
\\ sg`prob p (M1_F ∩ M2_S ∩ M3_F ∩ L2_S) = prob p M1_F * (prob p M2_S * (prob p M3_F * prob p L2_S))`
   >-( DEP_REWRITE_TAC [PROB_PATH11]
       \\ rw []
       \\ metis_tac [])
\\ sg`prob p (M1_F ∩ M2_S ∩ M3_F ∩ L2_F) =
      prob p M1_F * (prob p M2_S * (prob p M3_F * prob p L2_F))`
   >-( DEP_REWRITE_TAC [PROB_PATH12]
       \\ rw []
       \\ metis_tac [])
\\ sg`prob p (M1_F ∩ M2_F) = prob p M1_F * prob p M2_F`      
   >-( DEP_REWRITE_TAC [PROB_PATH13]
       \\ rw []
       \\ metis_tac [])
\\ fs []
\\ rw []
...
(*--------------------------------------------*)   
(* LEMMA 21  (Probability of Load B Failure)  *)
(*--------------------------------------------*)
...
``!M1_S M1_F M2_S M2_F M3_S M3_F L1_S L1_F L2_S L2_F p.
 ...
 (prob p (LOAD_B_FAILURE [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]) =

 (prob p M1_S) * ((prob p M2_F) * ((prob p M3_F) * (prob p L1_S))) +
 (prob p M1_S) * ((prob p M2_F) * ((prob p M3_F) * (prob p L1_F))) +
 (prob p M1_F) * (prob p M2_F))``,

rw [ETREE_LOAD_B_FAILURE_PATHS]
\\ sg `disjoint {M1_F ∩ M2_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_S;{}}`
   >-( DEP_REWRITE_TAC [DISJOINT_LOAD_B_FAILURE_PATHS]
       \\ fs [])
\\ sg `additive p `
   >-(rw [PROB_SPACE_ADDITIVE])
\\ sg ` prob p (M1_F ∩ M2_F ∪ M1_S ∩ M2_F ∩ M3_F ∩ L1_F ∪ M1_S ∩ M2_F ∩ M3_F ∩ L1_S) =
      prob p (ETREE (NODE
      (EVENT_TREE_LIST [M1_F ∩ M2_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_S ∩ M2_F ∩ M3_F ∩ L1_S; {}])))`
   >-(rw [EVENT_TREE_LIST_DEF, ETREE_DEF]
      \\ rw[UNION_OVER_INTER]
      \\ rw [INTER_ASSOC]
      \\ rw [UNION_ASSOC])
...
\\ sg`prob p (M1_S ∩ M2_F ∩ M3_F ∩ L1_S) = prob p M1_S * (prob p M2_F * (prob p M3_F * prob p L1_S))`
   >-( DEP_REWRITE_TAC [PROB_PATH7]
       \\ rw []
       \\ metis_tac [])
\\ sg`prob p (M1_S ∩ M2_F ∩ M3_F ∩ L1_F) =
      prob p M1_S * (prob p M2_F * (prob p M3_F * prob p L1_F))`
   >-( DEP_REWRITE_TAC [PROB_PATH6]
       \\ rw []
       \\ metis_tac [])
\\ sg`prob p (M1_F ∩ M2_F) = prob p M1_F * prob p M2_F`      
   >-( DEP_REWRITE_TAC [PROB_PATH13]
...
(*--------------------------------------------*)   
(* LEMMA 22  (Probability of Load C Failure)  *)
(*--------------------------------------------*)
...
``!M1_S M1_F M2_S M2_F M3_S M3_F L1_S L1_F L2_S L2_F p.
 ...
 (prob p (LOAD_C_FAILURE [M1_S; M1_F; M2_S; M2_F; M3_S; M3_F; L1_S; L1_F; L2_S; L2_F]) =
...
rw [ETREE_LOAD_C_FAILURE_PATHS]
\\ sg `disjoint {M1_S ∩ M2_S ∩ L1_F ∩ L2_F; M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_F;
                 M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_F ∩ M2_S ∩ M3_S ∩ L1_F ∩ L2_F;
	         M1_F ∩ M2_S ∩ M3_F ∩ L2_F; M1_F ∩ M2_F; {}}`
   >-( DEP_REWRITE_TAC [DISJOINT_LOAD_C_FAILURE_PATHS]
       \\ fs [])
\\ sg `additive p `
   >-(rw [PROB_SPACE_ADDITIVE])
\\ sg ` prob p ( M1_S ∩ M2_S ∩ L1_F ∩ L2_F ∪
      	       	 M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_F ∪
                 M1_S ∩ M2_F ∩ M3_F ∩ L1_F ∪
		 M1_F ∩ M2_S ∩ M3_S ∩ L1_F ∩ L2_F ∪
	         M1_F ∩ M2_S ∩ M3_F ∩ L2_F ∪
		 M1_F ∩ M2_F) =
      prob p (ETREE (NODE
      (EVENT_TREE_LIST [M1_S ∩ M2_S ∩ L1_F ∩ L2_F; M1_S ∩ M2_F ∩ M3_S ∩ L1_F ∩ L2_F;
                 M1_S ∩ M2_F ∩ M3_F ∩ L1_F; M1_F ∩ M2_S ∩ M3_S ∩ L1_F ∩ L2_F;
	         M1_F ∩ M2_S ∩ M3_F ∩ L2_F; M1_F ∩ M2_F; {}])))`
   >-(rw [EVENT_TREE_LIST_DEF, ETREE_DEF]
      \\ rw[UNION_OVER_INTER]
...
(*---------------------------------------------------------------------*)   
(* LEMMA 23  (Probability of Load A Failure Exponential Distribution)  *)
(*---------------------------------------------------------------------*)
...
``! M1 M2 M3 L1 L2 p t FR_M1 FR_M2 FR_M3 FR_L1 FR_L2.
  ...
  EXP_ET_DISTRIB p L2 FR_L2

   ==>
 
   (prob p (LOAD_A_FAILURE [SUCCESS p M1 t ; FAIL p M1 t ; SUCCESS p M2 t; FAIL p M2 t;
		            SUCCESS p M3 t; FAIL p M3 t; SUCCESS p L1 t; FAIL p L1 t;
		 	    SUCCESS p L2 t; FAIL p L2 t]) =
...
(*---------------------------------------------------------------------*)   
(* LEMMA 24  (Probability of Load B Failure Exponential Distribution)  *)
(*---------------------------------------------------------------------*)
...
``! M1 M2 M3 L1 L2 p t FR_M1 FR_M2 FR_M3 FR_L1 FR_L2.
  ...
  EXP_ET_DISTRIB p L2 FR_L2
   ...
   (prob p (LOAD_B_FAILURE [SUCCESS p M1 t ; FAIL p M1 t ; SUCCESS p M2 t; FAIL p M2 t;
		            SUCCESS p M3 t; FAIL p M3 t; SUCCESS p L1 t; FAIL p L1 t;
		 	    SUCCESS p L2 t; FAIL p L2 t]) =
...
(*---------------------------------------------------------------------*)   
(* LEMMA 25  (Probability of Load C Failure Exponential Distribution)  *)
(*---------------------------------------------------------------------*)
...
``! M1 M2 M3 L1 L2 p t FR_M1 FR_M2 FR_M3 FR_L1 FR_L2.
  ...
  EXP_ET_DISTRIB p L2 FR_L2
   ...
   (prob p (LOAD_C_FAILURE [SUCCESS p M1 t ; FAIL p M1 t ; SUCCESS p M2 t; FAIL p M2 t;
		            SUCCESS p M3 t; FAIL p M3 t; SUCCESS p L1 t; FAIL p L1 t;
		 	    SUCCESS p L2 t; FAIL p L2 t]) =
...
(*---------------------------------------------*)   
(* LEMMA 26  (SAIFI Exponential Distribution)  *)
(*---------------------------------------------*)
...
``! M1 M2 M3 L1 L2 p t FR_M1 FR_M2 FR_M3 FR_L1 FR_L2 X Y Z.
  ...
  EXP_ET_DISTRIB p L2 FR_L2
   ...
   ==>
(SAIFI
        [SUCCESS p L2 t;FAIL p L2 t][[SUCCESS p M1 t; FAIL p M1 t];[SUCCESS p M2 t; FAIL p M2 t];
	[SUCCESS p M3 t; FAIL p M3 t];[SUCCESS p L1 t; FAIL p L1 t]]
        [[31;30;29;28;27;26;25;24];[23;22];[21;20];[17;16];[15;14];[13;12];[9;8];[7;6];[5;4];[3;2;1;0]]
...
\\ rw[]
\\ DEP_REWRITE_TAC [GSYM ETREE_LOAD_A_FAILURE_PATHS]
\\ DEP_REWRITE_TAC [GSYM ETREE_LOAD_B_FAILURE_PATHS]
\\ DEP_REWRITE_TAC [GSYM ETREE_LOAD_C_FAILURE_PATHS]

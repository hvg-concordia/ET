(* ========================================================================= *)
(* File Name: IEE_3_BUS.sml	                 	                     *)
(*---------------------------------------------------------------------------*)
(*          Description: Reliability Analysis of a Standard IEEE 3-Bus       *)
(*                       Composite Bulk Power System                  	     *)
(*                                                                           *)
(*          HOL4-Kananaskis 13 		 			     	     *)
(*									     *)
...
SAIFI
``(((1 - exp (-1:real)) * (exp ((-5:real)/(2:real)))  * (1 - exp ((-3:real)/(2:real))) * (exp (-2:real)) +
   (1 - exp (-1:real)) * (exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (1- exp (-2:real)) +
   (1 - exp (-1:real)) * (1 - exp ((-5:real)/(2:real)))) * (2500:real) +
  ((1 - exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) *  (1- exp ((-5:real)/(4:real))) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (exp ((-5:real)/(4:real)))) * (900:real) +
  ((exp (-1:real)) * (exp ((-5:real)/(2:real))) * (1- exp ((-5:real)/(4:real))) * (1- exp (-2:real)) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (exp ((-3:real)/(2:real))) * (1- exp ((-5:real)/(4:real))) *
   (1- exp (-2:real)) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (1- exp ((-5:real)/(4:real))) +
   (1 - exp (-1:real)) * (exp ((-5:real)/(2:real))) * (exp ((-3:real)/(2:real))) * (1- exp ((-5:real)/(4:real))) *
   (1- exp (-2:real)) +
   (1 - exp (-1:real)) * (exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (1- exp (-2:real)) +
   (1 - exp (-1:real)) * (1 - exp ((-5:real)/(2:real)))) * (1800:real))/ (5200:real)``;

(*--------------------------------------------------------------------------------------------------*)

(*-----------------------------------------------------------------------*)   
(* Evaluation 6   (System Average Interruption Duration  Index (SAIDI))  *)
(*-----------------------------------------------------------------------*)

SAIDI
``(((1 - exp (-1:real)) * (exp ((-5:real)/(2:real)))  * (1 - exp ((-3:real)/(2:real))) * (exp (-2:real)) +
   (1 - exp (-1:real)) * (exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (1- exp (-2:real)) +
   (1 - exp (-1:real)) * (1 - exp ((-5:real)/(2:real)))) * (30:real) * (2500:real) +
  ((1 - exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) *  (1- exp ((-5:real)/(4:real))) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (exp ((-5:real)/(4:real)))) * (30:real) * (900:real) +
  ((exp (-1:real)) * (exp ((-5:real)/(2:real))) * (1- exp ((-5:real)/(4:real))) * (1- exp (-2:real)) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (exp ((-3:real)/(2:real))) * (1- exp ((-5:real)/(4:real))) *
   (1- exp (-2:real)) +
   (exp (-1:real)) * (1 - exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (1- exp ((-5:real)/(4:real))) +
   ...
   (1- exp (-2:real)) +
   (1 - exp (-1:real)) * (exp ((-5:real)/(2:real))) * (1 - exp ((-3:real)/(2:real))) * (1- exp (-2:real)) +
   (1 - exp (-1:real)) * (1 - exp ((-5:real)/(2:real)))) * (30:real) * (1800:real))/ (5200:real)``;
